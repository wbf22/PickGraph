...
public class PickGraph {
    ...
    public Map<String, Object> fulfillRequest(Map<String, Object> requestFields, Class<?> pickGraphObjectTarget, JsonFormat jsonFormat) {
    ...
    public Map<String, Object> fulfillRequest(Map<String, Object> requestFields, Class<?> pickGraphObjectTarget, Map<String, Object> args, JsonFormat jsonFormat) {
        return execute(requestFields, pickGraphObjectTarget, args, jsonFormat);
    }

    public Map<String, Object> execute(Map<String, Object> requestedFields, Class<?> pickGraphObjectTarget, Map<String, Object> args, JsonFormat jsonFormat) {
        try {
        ...
        for (Field field : fields) {
            if (requestedFields.containsKey(field.getName())) {
                ...
                if (field.getType().isAnnotationPresent(PickGraphObject.class)) {
                    ...
                    // TODO fix this so even non pick graph objects are filtered by query
                    fieldValue = traverseObject(
                            (Map<String, Object>) requestedFields.get(field.getName()),
                            fieldValue,
                            args,
                            caseformat
                        );
